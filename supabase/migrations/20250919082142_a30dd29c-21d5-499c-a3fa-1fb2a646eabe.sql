-- Create comprehensive user role system
-- First, create enum for all user roles
...
-- Update profiles table to support all roles and additional fields
...
-- Add additional profile fields for different user types
ALTER TABLE public.profiles 
