...
-- Ensure we only have the secure policies for profiles
-- (The existing policies should already be correct, but let's be explicit)
...
-- Create RLS policy for business directory - publicly viewable for business discovery
